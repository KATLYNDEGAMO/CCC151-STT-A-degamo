...
course_code_entry = tk.Entry(root, bd=2, font=("Arial", 12), bg=entry_bg_color)
course_code_entry.grid(row=8, column=1, padx=10, pady=5, sticky="w")
...
course_name_entry = tk.Entry(root, bd=2, font=("Arial", 12), bg=entry_bg_color)
course_name_entry.grid(row=9, column=1, padx=10, pady=5, sticky="w")
...
list_courses_button.grid(row=5, column=7, padx=10, pady=10)
